...
struct Product: Identifiable {
    ...
    Product(name: "Дорадо Охлажденная Непотрошеная 300-400г", price: 956, image: "4", discount: 25),
    Product(name: "Ролл Маленькая Япония 216г", price: 367, image: "5", specialOffer: .new),
    Product(name: "Огурцы тепличные cадово-огородные", price: 956, image: "6"),
    ...
    Product(name: "Огурцы тепличные cадово-огородные", price: 956, image: "15", specialOffer: .udar, discount: 25),
